...
class TestGraySwanContainer(unittest.TestCase):
    ...
    def test_default_configuration(self):
        ...
        self.assertEqual(
            container.config.agents.recon.output_dir(), "./output/recon_reports"
        )
    ...
    def test_configuration_from_dict(self):
        ...
        self.assertEqual(
            container.config.agents.recon.output_dir(), "./dict_output/recon_reports"
        )
...
class TestGraySwanPipeline(unittest.TestCase):
    ...
    def test_run_reconnaissance(self):
        ...
        self.mock_recon_agent.run_web_search.return_value = {
            "results": "web search results"
        }
        self.mock_recon_agent.run_discord_search.return_value = {
            "results": "discord search results"
        }
        ...
        result: Any = self.pipeline.run_reconnaissance(
            "GPT-4", "generate harmful content"
        )

        # Assert expected behavior
        self.mock_recon_agent.run_web_search.assert_called_once_with(
            "GPT-4", "generate harmful content"
        )
        self.mock_recon_agent.run_discord_search.assert_called_once_with(
            "GPT-4", "generate harmful content"
        )
    ...
    def test_run_evaluation(self):
        ...
        # Configure mock behavior
        self.mock_eval_agent.evaluate_results.return_value = {
            "evaluation": "test evaluation"
        }
        self.mock_eval_agent.create_visualizations.return_value = {
            "vis1": "/path/to/vis1.png"
        }
        self.mock_eval_agent.create_advanced_visualizations.return_value = {
            "vis2": "/path/to/vis2.png"
        }
        ...
        self.assertEqual(
            ...
            {"vis1": "/path/to/vis1.png", "vis2": "/path/to/vis2.png"},
        )
