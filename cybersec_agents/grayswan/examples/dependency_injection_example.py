...
def basic_example():
    ...
    print(f"Reconnaissance Agent: model={recon_agent.model_name}, output_dir={recon_agent.output_dir}")
    print(f"Prompt Engineer Agent: model={prompt_agent.model_name}, output_dir={prompt_agent.output_dir}")
    print(f"Exploit Delivery Agent: model={exploit_agent.model_name}, output_dir={exploit_agent.output_dir}")
    print(f"Evaluation Agent: model={eval_agent.model_name}, output_dir={eval_agent.output_dir}")
